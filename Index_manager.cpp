...
void Index_manager::drop_index(const string& index_name)
{
	...
	if (index_type == _INT)
		delete_index_int(index_name);
	else if (index_type == _CHAR)
		delete_index_char(index_name);
	else if (index_type == _FLOAT)
		delete_index_float(index_name);
	else if (index_type == _STRING)
		delete_index_string(index_name);
}

void Index_manager::delete_index_int(const string& index_name)
{
...
void Index_manager::delete_index_char(const string& index_name)
{
...
void Index_manager::delete_index_float(const string& index_name)
{
...
void Index_manager::delete_index_string(const string& index_name)
{
